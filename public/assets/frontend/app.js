$(document).ready(function () {
    ...
    $('.fashion-comment-store').click(function () {
        let body;
        ...
        if (body = comment_body.val().trim()) {
            ...
            $.ajax({
                ...
                statusCode: {
                    ...
                    200: function (data) {
                        $('.comment-div-' + parent_id).append("<div class='media'><a href='javascript:;' class='pull-left'><img src='" + avatar + "' alt='' class='media-object'> </a> <div class='media-body'><h4 class='media-heading'>" + data.user_name + "<span>" + data.time + "</span></h4><p>" + body + "</p></div></div>");
    ...
    $('.comment-delete-item').click(function () {
