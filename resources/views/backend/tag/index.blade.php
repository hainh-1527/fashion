        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="javascript:void(0)">{{ __('all_tags') }}</a>
                    </li>
                </ul>
            </div>
            <!-- END PAGE HEADER-->
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box green-haze">
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <a href="{{ route('tag.create') }}" id="sample_editable_1_new" class="btn green">
                                    <i class="fa fa-plus"></i>
                                    {{ __('add_new') }}
                                </a>
                                <a href="{{ route('tag.trash') }}" class="btn green">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                @foreach($tags as $key => $tag)
                                    <tr>
                                        ...
                                        <td>{{ $tag->name }}</td>
                                        <td>
                                            <span class="hide">{{ __($tag->status) }}</span>
                                            ...
                                            {!! Form::select(
                                                ...
                                                [
                                                    ...
                                                    'data-url' => route('api.tag.update', $tag->id),
                                                    'data-message' => __('update_success')
                                                ]
                                            ) !!}

                                        </td>
                                        <td class="fashion-time">{{ $tag->updated_at }}</td>
                                        <td class="fashion-user">{{ $tag->user->name or null }}</td>
                                        <td>
                                            <a href="{{ route('tag.edit', $tag->id) }}" class="btn default btn-xs purple">
                                                <i class="fa fa-edit"></i>
                                                {{ __('edit_item') }}
                                            </a>
                                            <span data-url="{{ route('api.tag.soft_delete', $tag->id) }}"
