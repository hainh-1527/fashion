                            ...
                            <div class="actions">
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li>
                                            <a href="{{ route('brand.restore.all') }}">
                                                <i class="fa fa-reply"></i>
                                                {{ __('restore_all') }}
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('brand.restore.time', 3600) }}">
                                                <i class="fa fa-clock-o"></i>
                                                {{ __('1_hours') }}
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('brand.restore.time', 86400) }}">
                                                <i class="fa fa-clock-o"></i>
                                                {{ __('24_hours') }}
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('brand.restore.time', 604800) }}">
                                                <i class="fa fa-clock-o"></i>
                                                {{ __('7_day') }}
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('brand.restore.time', 2592000) }}">
                                                <i class="fa fa-clock-o"></i>
                                                {{ __('30_day') }}
                                            </a>
                                        </li>
                                ...
                                @foreach($brands as $key => $brand)
                                    <tr>
                                        <td>
                                            ...
                                            {!! Form::checkbox('brands_id[]', $brand->id, null, ['class' => 'checkboxes']) !!}
                                        ...
                                        <td>
                                            <span data-url="{{ route('api.brand.restore.item', $brand->id) }}" data-message="{{ __('restore_success') }}" class="btn default btn-xs green fashion-restore-item">
                                                <i class="fa fa-reply"></i>
                                                {{ __('restore') }}
                                            </span>
                                            <span data-url="{{ route('api.brand.force_delete', $brand->id) }}"
