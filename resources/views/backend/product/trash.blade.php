...
@section('content')
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <!-- END PAGE HEADER-->
            <!-- BEGIN PAGE CONTENT-->
            {!! Form::open(['route' => ['product.restore']]) !!}
            <div class="row">
                <div class="col-md-12">
                            ...
                            <div class="actions">
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li>
                                            <a href="{{ route('product.restore.all') }}">
                                                <i class="fa fa-reply"></i>
                                                {{ __('restore_all') }}
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('product.restore.time', 3600) }}">
                                                <i class="fa fa-clock-o"></i>
                                                {{ __('1_hours') }}
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('product.restore.time', 86400) }}">
                                                <i class="fa fa-clock-o"></i>
                                                {{ __('24_hours') }}
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('product.restore.time', 604800) }}">
                                                <i class="fa fa-clock-o"></i>
                                                {{ __('7_day') }}
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('product.restore.time', 2592000) }}">
                                                <i class="fa fa-clock-o"></i>
                                                {{ __('30_day') }}
                                            </a>
                                        </li>
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover" id="sample_2">
                                ...
                                @foreach($products as $key => $product)
                                    <tr>
                                        <td>
                                            {!! Form::checkbox('products_id[]', $product->id, null, ['class' => 'checkboxes']) !!}
                                        </td>
                                        <td>{{ ++$key }}</td>
                                        ...
                                        <td>
                                            <span data-url="{{ route('api.product.restore.item', $product->id) }}" data-message="{{ __('restore_success') }}" class="btn default btn-xs green fashion-restore-item">
                                                <i class="fa fa-reply"></i>
                                                {{ __('restore') }}
                                            </span>
                                            <span data-url="{{ route('api.product.force_delete', $product->id) }}"
